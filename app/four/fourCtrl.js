...
// ============================================================
angular.module("gameApp").controller("fourCtrl", function($scope) {
  ...
  b.cell("each").style({width: "70px", height: "70px", background: "#lightgray", border: "1px solid #748faa", borderRadius: "3px"});
  ...
  var black = jsboard.piece({text:"R", textIndent:"-9999px", background: "url('./images/black.png') no-repeat", width: "50px", height: "50px", margin: "0 auto" });
